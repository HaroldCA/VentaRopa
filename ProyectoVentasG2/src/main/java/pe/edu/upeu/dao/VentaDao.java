...
public class VentaDao extends AppCrud{
    ...
    public VentaTO crearVenta() {
        ...
        lar=new LeerArchivo("Venta.txt");
        ventTO=new VentaTO();
        ventTO.setIdVenta(generarId(lar, 0, "V00", 1));
    ...
    public void reporteVentasRangoFecha() {
        ...
        //ut.pintarLine('H', 45);    
        System.out.println(colorX.render("| Total Neto Ventas: S/."+(Math.round(netoTotalX*100.0)/100.0)+" | "+
        "Total IGV a pagar: S/."+ (Math.round(igvX*100.0)/100.0)+" | "+"Monto Recaudado: S/."+
